...
public:
	...
	ScaleOptimizer(int w_, int h_, const Eigen::Matrix3f &K, const SE3& T_stereo_, float accept_th_);
	~ScaleOptimizer();
...
private:
  ...
  std::vector<float*> ptrToDelete;
	...
	void calcGSSSE(int lvl, float &H_out, float &b_out, const SE3 &refToNew, float scale);
